...
```bash
python run_case2.py --K-list 1 2 4 8 --r-list 0 1 2 --n-its 50000
python scan_nits.py --K 8 --r 2
python plot_case2.py --summary outputs/case2_5d_smooth/ouq_bounds_summary.csv
```
